...
// --- Google OAuth Setup (Using your provided IDs) ---
const GOOGLE_CLIENT_ID = process.env.GOOGLE_CLIENT_ID; // 62866830906-89e5aqkrpnsjs0dri6hsss239b5rpdd9... (Web Client ID)
// Used for verifying tokens originating from the native Android app
const GOOGLE_ANDROID_CLIENT_ID = process.env.GOOGLE_ANDROID_CLIENT_ID; // 62866830906-8n2g7q7h19cvsuq81eucf96cv56lglkl... (Android Client ID)

const client = new OAuth2Client(GOOGLE_CLIENT_ID);
const saltRounds = 10;

/** * Helper to generate token & send response safely.
 * IMPORTANT: This function returns the JWT in the response body (for mobile apps) 
 * AND sets the HttpOnly cookie (for web browsers).
 */
...
/** -------------------------
 * LOCAL REGISTER
 * Uses the standard generateToken helper.
 --------------------------*/
 ...
 * This handles ID tokens from both your Web and Android clients.
 --------------------------*/
router.post('/google', async (req, res) => {
  ...
  try {
    // CRITICAL: Tokens generated by the Capacitor Android app will use the Android Client ID.
    // We must verify the token against both the Web and Android Client IDs.
    const VALID_AUDIENCES = [GOOGLE_CLIENT_ID]; // Always include the Web Client ID
    ...
    if (GOOGLE_ANDROID_CLIENT_ID) {
      ...
      console.log('Verifying Google token against multiple audiences:', VALID_AUDIENCES);
        ...
        console.warn('WARNING: GOOGLE_ANDROID_CLIENT_ID is missing. Native app logins may fail.');
    }
